...
DEFAULTS: dict[str, Any] = {
    ...
    'upstream': {
        ...
        'hbb_common_policy': 'exact-version',
        'resolve_each_prepare': True,
        'force_refresh_each_prepare': True,
    ...
    'github_actions': {
        ...
        'publish_release_default': False,
        'disable_upstream_nightly_schedule': True,
    },
    'safety': {
...
def validate_config(cfg: dict[str, Any]) -> list[str]:
    ...
    if str(upstream.get('hbb_common_policy', 'exact-version')) != 'exact-version':
        errors.append('upstream.hbb_common_policy deve ser exact-version')
    if bool(upstream.get('allow_main_fallback', False)):
        errors.append('upstream.allow_main_fallback deve permanecer false')
