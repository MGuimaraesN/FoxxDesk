...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep RustDesk background service", "Mantene su servìtziu de FoxxDesk in s'isfundu"),
        ...
        ("About RustDesk", "Informatziones subra de FoxxDesk"),
