...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Joissain tapauksissa FoxxDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi RustDeskin järjestelmään."),
        ...
        ("Language", "Kieli"),
        ("Keep FoxxDesk background service", "Pidä RustDeskin taustapalvelu käynnissä"),
        ...
        ("About FoxxDesk", "Tietoa RustDeskistä"),
