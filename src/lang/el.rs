...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Γλώσσα"),
        ("Keep FoxxDesk background service", "Διατήρηση της υπηρεσίας παρασκηνίου του FoxxDesk"),
        ...
        ("Show FoxxDesk", "Εμφάνιση του FoxxDesk"),
        ...
        ("About FoxxDesk", "Πληροφορίες για το FoxxDesk"),
