...
///
/// Note:
/// On linux, we use dbus to communicate between multiple foxxdesk processes.
...
const DBUS_NAME: &str = "org.foxxdesk.foxxdesk";
...
/// `dbus-send --session --print-reply --dest=org.foxxdesk.foxxdesk /dbus org.foxxdesk.foxxdesk.NewConnection string:'PEER_ID'`
