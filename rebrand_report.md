...
- Pendências: `0`
- Backup: `/home/mateus/_Projects/FoxxDesk/.rebrand_backup/20260904_215222`
- Log detalhado: `/home/mateus/_Projects/FoxxDesk/rebrand_v36.log`
...
| alterado | `.github/workflows/bridge.yml` | 92 | aplicar regras standalone de rebrand | conteúdo textual mudou por regra segura; sem payload/ZIP |
| alterado | `.github/workflows/flutter-build.yml` | 262 | aplicar regras standalone de rebrand | conteúdo textual mudou por regra segura; sem payload/ZIP |
