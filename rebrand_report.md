...
- Arquivos alterados: `250`
- Arquivos já aplicados/sem mudança: `33`
- Arquivos esperados não encontrados: `0`
- Arquivos ignorados: `8`
- Renomeações/cópias criadas: `8`
- Pendências: `0`
- Backup: `/home/mateus/_Projects/FoxxDesk/.rebrand_backup/20260704_134318`
- Log detalhado: `/home/mateus/_Projects/FoxxDesk/rebrand_v29.log`
...
|---|---|---:|---|---|
| baixado/atualizado | `libs/hbb_common` | 1 | garantir hbb_common antes do rebrand | usa o comando solicitado para restaurar libs/hbb_common antes de aplicar o brand (ausente/incompleto) |
| criado | `.github/workflows/foxxdesk-build.yml` | 1 | criar workflow principal FoxxDesk se ausente | arquivo gerado pela V25; sem payload/ZIP e sem snapshot de projeto antigo |
...
| alterado | `scripts/apply_foxxdesk_icon.py` | 3 | criar/atualizar gerador de assets de ícone FoxxDesk | arquivo gerado pela V25; sem payload/ZIP e sem snapshot de projeto antigo |
...
| gerado | `icon assets` | 1 | gerar assets de ícone FoxxDesk | gerador executado com fonte res/icon.png; arquivos alterados/planejados: 54; relatório em icon_assets_report.md |
